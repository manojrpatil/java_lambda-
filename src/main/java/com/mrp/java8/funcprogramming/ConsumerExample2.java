...
public class ConsumerExample2 {
    public static void main(String[] args) {
        ...
        System.out.println("looping through all the instructor and printing out the values of instructor");
        ...
        System.out.println("---------------");
        System.out.println("Loop through all the instructor and only print out their name");
        ...
        System.out.println("----------------");
        System.out.println("Loop through all the instructors and print out their names and their courses");
        ...
        System.out.println("----------");
        System.out.println("Loop through all the instructors and print out their name if the years of experience is >10");
        ...
        System.out.println("--------------");
        System.out.println("Loop through all the instructors and print out their name and years of experience if years\n" +
                "        of experience is >5 and teaches course online");
        instructors.forEach(s1->{
